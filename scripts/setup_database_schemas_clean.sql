...
-- Schema creation
CREATE SCHEMA IF NOT EXISTS search AUTHORIZATION hh_app;
CREATE SCHEMA IF NOT EXISTS taxonomy AUTHORIZATION hh_app;
CREATE SCHEMA IF NOT EXISTS msgs AUTHORIZATION hh_app;
CREATE SCHEMA IF NOT EXISTS ops AUTHORIZATION hh_app;
