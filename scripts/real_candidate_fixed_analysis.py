...
async def main():
    ...
    if successful_profiles:
        ...
        summary = sample.get('executive_recruiting_summary', {})
        
        print(f"   👤 Candidate: {sample.get('candidate_id', 'N/A')}")
        print(f"   📊 Job Stability: {job_stability.get('stability_score', 'N/A')}/10")
        print(f"   💰 Salary Range: {compensation.get('brazil_salary_range', 'N/A')}")
        print(f"   ⚡ Marketability: {placement.get('marketability_score', 'N/A')}/100")
